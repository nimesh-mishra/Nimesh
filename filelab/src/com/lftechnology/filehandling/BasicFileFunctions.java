...
public class BasicFileFunctions {
	 ...
	 * @param fileName {@link String} Name of File
	 */
	...
	public static void main(String[] args) {
		...
		if(file.exists()&&file.isFile()){
			...
			String fullNewName=file.getAbsolutePath().replaceAll(file.getName(), newName);
		File renamedFile=new File(fullNewName);
			if(file.renameTo(renamedFile)){
				System.out.println("File Renamed to :\t "+fullNewName);
				file.setWritable(true);	
				BasicFileFunctions question=new BasicFileFunctions(fullNewName);
